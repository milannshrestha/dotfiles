...
export declare function prettierTslintify(code: string, fileFsPath: string, range: Range, vlsFormatConfig: VLSFormatConfig, parser: ParserOption, initialIndent: boolean): TextEdit[];
