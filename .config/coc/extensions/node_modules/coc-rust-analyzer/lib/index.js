...
const cmds = __importStar(__webpack_require__(10));
const ctx_1 = __webpack_require__(46);
const status_display_1 = __webpack_require__(48);
async function activate(context) {
    const ctx = new ctx_1.Ctx(context);
    const run = client_1.prepare(ctx.config);
    if (!run) {
        coc_nvim_1.workspace.showMessage(`ra_lsp_server is not found, you need to build rust-analyzer from source`, 'error');
        const ret = await coc_nvim_1.workspace.showQuickpick(['Yes', 'No'], 'Get ra_lsp_server?');
        if (ret === 0) {
            coc_nvim_1.commands.executeCommand('vscode.open', 'https://github.com/rust-analyzer/rust-analyzer').catch(() => { });
        }
        return;
    }
...
const which_1 = __importDefault(__webpack_require__(4));
...
const isexe = __webpack_require__(6)
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const sourceChange = __importStar(__webpack_require__(11));
const analyzer_status_1 = __webpack_require__(38);
exports.analyzerStatus = analyzer_status_1.analyzerStatus;
const expand_macro_1 = __webpack_require__(39);
exports.expandMacro = expand_macro_1.expandMacro;
const join_lines_1 = __webpack_require__(40);
exports.joinLines = join_lines_1.joinLines;
const matching_brace_1 = __webpack_require__(41);
exports.matchingBrace = matching_brace_1.matchingBrace;
const on_enter_1 = __webpack_require__(42);
exports.onEnter = on_enter_1.onEnter;
const parent_module_1 = __webpack_require__(43);
exports.parentModule = parent_module_1.parentModule;
const runnables_1 = __webpack_require__(44);
exports.run = runnables_1.run;
exports.runSingle = runnables_1.runSingle;
const syntax_tree_1 = __webpack_require__(45);
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const source_change_1 = __webpack_require__(11);
...
class Ctx {
    ...
    async restartServer() {
        ...
        this.client = null;
        const client = client_1.createClient(this.config);
        if (!client) {
            return;
        }
